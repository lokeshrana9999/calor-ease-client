...
import { SearchHistoryStats } from '@/lib/searchHistory';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/Card';

interface SearchHistoryStatsProps {
  stats: SearchHistoryStats;
}

export function SearchHistoryStatsComponent({ stats }: SearchHistoryStatsProps) {
  const statItems = [
    {
    ...
    },
    {
      ...
      value: stats.averageCaloriesPerSearch.toLocaleString(),
      icon: (
        ...
        <CardContent>
          <div className="text-center">
            <p className="text-3xl font-bold text-gray-900 capitalize mb-2">
              {stats.mostSearchedDish}
            </p>
            <p className="text-gray-600">
              Your favorite dish to track calories for
            </p>
          </div>
        </CardContent>
      </Card>
